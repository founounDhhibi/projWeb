			...
			<section class="container-fluid">
				...
				<div class="row pagehead">
					...
					<div class="col-sm-8 col-xs-8" id="logo">
						<a href="index.html"><img src="logo.png" alt="Shof Store Logo"></a>
					</div>
					<div class="col-sm-1 col-sm-offset-1 col-xs-2">
						...
						<div id="cartpopup">
							...
							<div class="cartitem">
								<img src="logo.png" width="100" height="100" alt="Cart Item 2"><p class="boldest"><a href="#">&times;&nbsp;</a><a href="#">Cleon Mono Chair</a></p>	
								<p class="bolder">$299.00</p>
							</div>
							<div class="cartitem">
								<img src="logo.png" width="100" height="100" alt="Cart Item 3"><p class="boldest"><a href="#">&times;&nbsp;</a><a href="#">Cleon Lounge Chair</a></p>	
