...
<form id="UserForm" action="" method="POST">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="nom_user" name="nom_user" required minlength="2" pattern="[A-Za-z]+" title="Le nom doit contenir uniquement des lettres et au moins 2 caractères.">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="prenom_user" name="prenom_user" required minlength="2" pattern="[A-Za-z]+" title="Le prénom doit contenir uniquement des lettres et au moins 2 caractères.">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="email" class="form-control" id="email_user" name="email_user" required title="Veuillez entrer un email valide.">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="tel" class="form-control" id="tel_user" name="tel_user" required pattern="[0-9]{8,15}" title="Le téléphone doit contenir entre 8 et 15 chiffres.">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="adresse_user" name="adresse_user" required minlength="5" title="L'adresse doit contenir au moins 5 caractères.">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="username" name="username" required minlength="3" title="Le nom d'utilisateur doit contenir au moins 3 caractères.">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="password" class="form-control" id="password_user" name="password_user" required minlength="6" title="Le mot de passe doit contenir au moins 6 caractères.">
        </div>
    </div>
