    ...
    <body>
                                ...
                                <form action="payerCommande.php" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="code_coupon" placeholder="Enter your code coupon">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-md-6">
        ...
        <div class="footer">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="contact-info">
                                ...
                                <p><i class="fa fa-phone"></i>+216-71-678-908</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row payement align-items-center">
                    <div class="col-md-6">
                        <div class="methode de payeyement">
                            <h2>We Accept:</h2>
                            <img src="img/payment-method.png" alt="Payment Method" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="payement securise">
                            <h2>Secured By:</h2>
