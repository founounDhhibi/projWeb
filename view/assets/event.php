...
if (isset($_POST["search"])) {
    ...
    $query = $eventController->paginationLIMIT($sqlSearch);
    ////////////COUNTER
    $sql = "SELECT COUNT(*) FROM event";
    $total_recordse = $eventController->paginationCOUNTER($sql);
}
...
<div class="wrapper">
        ...
        <div class="container">
            <div class="page-inner">
                <div class="page-header">
                    <h3 class="fw-bold mb-3">Evénements</h3>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Liste des évenements</div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        <option
                                            <?php
                                            if (isset($_POST["filter_type"])) {
                                                if ($_POST["filter_type"] == "Economie") {
                                                    echo "selected";
                                                }
                                            }
                                            ?>
                                                value="Economie">Broderie
                                        </option>
                                        <option
                                            <?php
                                            if (isset($_POST["filter_type"])) {
                                                if ($_POST["filter_type"] == "Culture") {
                                                    echo "selected";
                                                }
                                            }
                                            ?>
                                                value="Culture">Tissage
                                        </option>
                                    </select>
                                </div>
                            </form>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        foreach ($events as $event) {
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../Front Web/img/<?php echo $event['image']; ?>"
                                                         style="max-width: 62px; max-height: 62px; border-radius: 50%">
                                                </td>
                                                <td><?php echo $event['nom_event']; ?></td>
                                                <td><?php echo $event['description_event']; ?></td>
                                                <td><?php echo $event['date_event']; ?></td>
                                                <td><?php echo $event['nbr_place']; ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        ...
                                                        //   if($event['date_event'] > ) {}
                                                        ?>
                                                        <a href="qrcode.php?id_event=<?php echo $event['id_event']; ?>"
                                                           style="font-weight: 600;">QRCode</a>
                                                        <a href="updateEvent.php?id_event=<?php echo $event['id_event']; ?>"
                                                           style="color: yellowgreen; font-weight: 600;">Update</a>
                                                        <a href="deleteEvent.php?id_event=<?php echo $event['id_event']; ?>"
                                                           style="color: red; font-weight: 600;">Delete</a>
                                                        <a href="participants.php?id_event=<?php echo $event['id_event']; ?>"
                                                           style="font-weight: 600;">Participants</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <div class="pagination" style="padding-left:40%;">
                                            ...
                                            if ($page >= 2) {
                                                echo "<a href='event.php?page=" . ($page - 1) . "'>  Prev </a>";
                                            }

                                            for ($i = 1; $i <= $total_pages; $i++) {
                                                if ($i == $page) {
                                                    $pagLink .= "<a class='active' href='event.php?page=" . $i . "'>" . $i . "</a>";
                                                } else {
                                                    $pagLink .= "<a href='event.php?page=" . $i . "'>" . $i . "</a>";
                                                }
                                            }
                                            echo $pagLink;

                                            if ($page < $total_pages) {
                                                echo "<a href='event.php?page=" . ($page + 1) . "'>  Next </a>";
                                            }
                                            ?>
                                        </div>
                                    <?php } ?>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Ajouter un évenement</div>
                            </div>
                            <form action="add_event.php" method="post" id="eventForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="event_desc" name="event_desc"
                                              rows="5"></textarea>
    ...
    <script src="event%20JS/cntrl_saisie.js"></script>
</body>
</html>
