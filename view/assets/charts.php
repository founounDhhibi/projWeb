              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="../view/assets/img/jm_denis.jpg"
                                alt="Img Profile"
                              />
                            </div>
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="../view/assets/img/vortex.png"
                        alt="..."
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                      <li>
                        <div class="user-box">
                          <div class="avatar-lg">
                            <img
                              src="../view/assets/img/profile.jpg"
                              alt="image profile"
                ...
                echo '<div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Event: ' . htmlspecialchars($row['nom_event']) . '</div>
                                </div>
                                <div class="card-body">
                                <p>Description: ' . htmlspecialchars($row['description_event']) . '</p>
                                <p>Date: ' . htmlspecialchars($row['date_event']) . '</p>
                                <!-- Si tu souhaites ajouter dautres champs, comme localisation ou catégorie, tu devras les ajouter à ta table -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" style="display:inline;" id="deleteEventForm">
                ...
                <?php if (isset($row['id_event'])): ?>
                    <input type="hidden" name="id_event" value="<?php echo htmlspecialchars($row['id_event']); ?>">
                <?php else: ?>
