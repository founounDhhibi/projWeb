                ...
                <span class="sidebar-mini-icon">
                  <i class="fa fa-ellipsis-h"></i>
                    ...
                    <li class="nav-item active submenu">
                        <a data-bs-toggle="collapse" href="event.php">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Modifier un évenement</div>
                            </div>
                            <form action="add_event.php" method="post" id="eventEditForm" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="<?php echo $event['nom_event']; ?>"
                                    />
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="<?php echo $event['nbr_place']; ?>"
                                    />
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        name="event_type"
                                    >
                                        <option <?php if($event['type'] == "Tech") echo 'selected'; ?> value="Tech">Tech</option>
                                        <option <?php if($event['type'] == "Economie") echo 'selected'; ?> value="Economie">Economie</option>
                                        <option <?php if($event['type'] == "Culture") echo 'selected'; ?> value="Culture">Culture</option>
