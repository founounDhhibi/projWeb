        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="sn-container">
                    <div class="sn-img">
                        <img src="img/<?php echo $participation['image']; ?>"/>
                    </div>
                    <div class="sn-content">
                        <h1 class="sn-title"><?php echo $participation['nom_event']; ?></h1>
                        <p>
                            <?php echo $participation['description_event']; ?>
                        </p>
                        <a href="deleteParticipation.php?id_event=<?php echo $participation['id_event']; ?>&id_user=<?php echo $user_id; ?>" class="btn">Annuler</a>
                    </div>
                </div>
                <?php } ?>
            </div>
