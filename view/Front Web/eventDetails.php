...
<div class="breadcrumb-wrap">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">#<?php echo $event['id_event']; ?></li>
        </ul>
    </div>
</div>
<!-- Breadcrumb End -->
            ...
            <div class="col-lg-8">
                <div class="sn-container">
                    ...
                    <div class="sn-content">
                        <h1 class="sn-title"><?php echo $event['nom_event']; ?></h1>
                        <p>
                            <?php echo $event['description_event']; ?>
                        </p>
                        <p>NBR Place : <?php echo $event['nbr_place']; ?></p>
                        <p>Date : <?php echo $event['date_event']; ?></p>
                        <p>Type : <?php echo $event['type']; ?></p>
                        <a href="participerEvent.php?id_event=<?php echo $event['id_event']; ?>&id_user=<?php echo $user_id; ?>" class="btn">Participer</a>
                    </div>
                </div>
            </div>
        </div>
