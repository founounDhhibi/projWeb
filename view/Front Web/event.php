...
<div class="cat-news">
    <div class="container">
        <a href="mesParticipations.php?id_user=<?php echo $user_id; ?>" class="btn">Mes participations</a>
        <div class="row">
            <div class="col-md-6">
                <h2>Poterie</h2>
                <div class="row cn-slider">
                    <?php foreach ($events as $event) {
                        if ($event['type'] == "Poterie") {
                            ?>
                            <div class="col-md-6">
                                <div class="cn-img">
                                    <img src="img/<?php echo $event['image']; ?>" />
                                    <div class="cn-title">
                                        <a href="eventDetails.php?id_event=<?php echo $event['id_event']; ?>"><?php echo $event['nom_event']; ?></a>
                                    </div>
                                </div>
                            </div>
                        <?php }
